...
export default async function Page() {
  return (
    <p className={styles.textContainer}>
      ...
      Richtigkeit, Vollständigkeit und Aktu- alität der Inhalte können wir
      jedoch keine Gewähr übernehmen. Als Diensteanbieter sind wir gemäß § 7
      Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen
      Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter
      jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde
      Informatio- nen zu überwachen oder nach Umständen zu forschen, die auf
      eine rechtswidrige Tätigkeit hinweisen. Ver- pflichtungen zur Entfernung
      ...
      Inhalte wir keinen Einfluss haben. Des- halb können wir für diese fremden
      ...
      Zeit- punkt der Verlinkung nicht erkennbar. Eine permanente inhaltliche
      ...
      unterlie- gen. Soweit die Inhalte auf dieser Seite nicht vom Betreiber
      ...
      eine Urhe- berrechtsverletzung aufmerksam werden, bitten wir um einen
