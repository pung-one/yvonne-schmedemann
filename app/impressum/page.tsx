...
export default async function Page() {
  return (
    <p style={{ margin: "250px 100px", maxWidth: "600px", lineHeight: "25px" }}>
      ...
      <br />
      Inhaltlich Verantwortlicher gemäß § 55 Abs. 2 RStV: Yvonne Schmedemann
      <br />
      (Anschrift wie oben)
      <br />
      <br />
      ...
      geprüft und wer- den regelmäßig aktu- alisiert. Jedoch können wir keine
      Garantie dafür übernehmen, dass alle Angaben zu jeder Zeit aktuell,
      richtig und vollständig sind. Trotz sorgfältiger inhaltlicher Kontrolle
      ...
      <br />
      <br />
      © 2024 - all pictures: YVONNE SCHMEDEMANN
      <br />
      <br />
      DATENSCHUTZ:
      <br />
      ...
      erzeugten Informationen über Ihre Be- nutzung dieser Website
      (einschließlich Ihrer IP-Adresse) wird an einen Server von Google in den
      USA übertra- gen und dort gespeichert. Google wird diese Informationen
      benutzen, um Ihre Nutzung der Website auszuwer- ten, um Reports über die
      ...
      Sie jedoch darauf hin, dass Sie in diesem Fall ge- gebenenfalls nicht
      ...
      including all offers and infor- mation might be extended, changed or
      partly or completely deleted by the author without separate announce-
      ment.
      <br />
      <br />
      ...
      his pages - unless he has full know- ledge of illegal contents and would
      be able to prevent the visitors of his site fromviewing those pages. If
      any da- mage occurs by the use of information presented there, only the
      author of the respective pages might be liable, not the one who has linked
      to these pages. Furthermore the author is not liable for any postings or
      ...
      respective object.The copyright for any material created by the author is
      reserved. Any dupli- cation or use of objects such as images, diagrams,
